...
@Slf4j
public class ModifyResponseBodyTransformerFunc extends AbstractBodyTransformerFunc
    implements RewriteFunction<String, String> {

  public ModifyResponseBodyTransformerFunc(
  ...
  public Publisher<String> apply(ServerWebExchange exchange, String s) {
    return transform(exchange, s, true);
  }
}
