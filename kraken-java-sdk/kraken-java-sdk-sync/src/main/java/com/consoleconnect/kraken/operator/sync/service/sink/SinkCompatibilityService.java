...
@Slf4j
public class SinkCompatibilityService implements ClientSinkService {
  private final UnifiedAssetService unifiedAssetService;
  private final DataIngestionJob dataIngestionJob;

  @Override
  public AssetKindEnum getKind() {
    return AssetKindEnum.PRODUCT_COMPATIBILITY;
  }

  @Override
  public void handleLatest(List<UnifiedAssetDto> latestAssets) {
    latestAssets.forEach(this::ingestCompatibilityComponent);
  }

  private void ingestCompatibilityComponent(UnifiedAssetDto assetDto) {
