...
public class SinkBuyerService implements ClientSinkService {
  ...
  @Override
  public void handleLatest(List<UnifiedAssetDto> list) {
    handleBuyers(list);
  }

  public void handleBuyers(List<UnifiedAssetDto> receivedBuyers) {
  ...
  private void processBuyerUpdate(UnifiedAssetDto dto, String parentId) {
    ...
    event.setEnforceSync(appProperty.isAssetConfigOverwriteFlag());
