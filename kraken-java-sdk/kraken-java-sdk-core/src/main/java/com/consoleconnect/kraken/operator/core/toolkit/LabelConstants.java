...
public class LabelConstants {
  ...
  public static final String LABEL_DEPLOYED_STATUS = "deployedStatus";
  public static final String LABEL_STAGE_DEPLOYED_STATUS = "stageDeployedStatus";
  public static final String LABEL_APP_TEMPLATE_UPGRADE_ID = "appTemplateUpgradeId";
  public static final String LABEL_APP_TEMPLATE_DEPLOYMENT_ID = "appTemplateDeploymentId";
